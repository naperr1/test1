<%-- 
    ...
    Created on : Nov 23, 2023, 4:57:21 PM
    Author     : Fattt
--%>
...
<body>
    ...
    <div class="main">
        ...
        <div class="product">
            ...
            <form class="product__form" action="updateCustomer" method="post">
                ...
                <div class="form-group">
                    <label for="role">Role</label>
                     <input type="number" id="admin" name="admin" value="${c.isAdmin} required />
                </div>
                <div class="form__btn">
                    <button type="submit">Update</button>
                    <a href="manageCustomers.html">Cancel</a>
                </div>
            </form>
        </div>
    </div>
